...
st.markdown("""
    ...
    /* 6. FITUR BARU: Mengubah Warna Jam (Timestamp) Menjadi Sangat Jelas ⏰ */
    .time-text {
        font-size: 0.8rem;
        font-weight: 700;
        color: #1e293b !important; /* Warna Gelap Pekat yang sangat kontras dengan background terang */
        background-color: rgba(255, 255, 255, 0.6); /* Efek background mini agar teks jam makin pop-up */
        padding: 2px 6px;
        border-radius: 4px;
        display: inline-block;
        margin-top: 5px;
...
st.markdown('<div class="subtitle">Database Agent • Tampilan Clean • Jam Jelas Kontras • Kaya Emotikon ✨</div>', unsafe_allow_html=True)
...
if len(st.session_state.messages) == 0:
    st.chat_message("assistant").markdown("Halo! 👋 Saya adalah AI profesional database toko komputer Anda. 💻 Background saya sudah kembali bersih, indikator jam disetel sangat jelas ⏰, dan saya siap menghias jawaban menarik dengan emotikon seru! ✨")
