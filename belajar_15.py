...
# ==============================================================================
# 2. SIDEBAR CONFIGURATION & AUDIO PARAMS ⚙️
# ==============================================================================
voice_params = {
...
with st.sidebar:
    ...
    # ==================== FITUR BARU: WHATSAPP-LIKE VIDEO UPLOAD (MAX 10 MB) ====================
    st.markdown("---")
    ...
    if uploaded_video is not None:
        ...
        if uploaded_video.size > max_size:
            ...
            # Tampilan preview video mirip WhatsApp di sidebar player
        ...
        with st.spinner(f"🔍 [{ai_engine}] Merumuskan jawaban terbaik berdasarkan basis data..."):
            try:
                ...
                # JALUR EKSEKUSI 2: OPENAI GPT
                    ...
                    # Menyusun payload pesan dengan memasukkan system instruction di awal array
